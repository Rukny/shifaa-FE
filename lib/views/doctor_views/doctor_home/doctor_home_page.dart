...
import 'package:shifaa/controllers/doctor_nav_provider.dart';
...
class DoctorHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: ChangeNotifierProvider<DoctorNavProvider>(
        create: (context) => DoctorNavProvider(),
        builder: (_, child) => Consumer<DoctorNavProvider>(
          builder: (context, prov, child) {
            return AdvancedDrawer(
              ...
              child: Scaffold(
                ...
                body: SingleChildScrollView(child: prov.currentPage),
              ),
            );
          },
        ),
